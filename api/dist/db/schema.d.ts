export declare const documentType: import("drizzle-orm/pg-core").PgEnum<["text", "scanned", "mixed"]>;
export declare const documentStatus: import("drizzle-orm/pg-core").PgEnum<["uploading", "processing", "ready", "failed"]>;
export declare const messageRole: import("drizzle-orm/pg-core").PgEnum<["user", "assistant", "system"]>;
export declare const quizStatus: import("drizzle-orm/pg-core").PgEnum<["not_started", "in_progress", "passed", "failed"]>;
export declare const reminderStatus: import("drizzle-orm/pg-core").PgEnum<["pending", "sent", "dismissed"]>;
...
export declare const summaries: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "summaries";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
